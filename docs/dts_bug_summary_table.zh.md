...
| 132 | filemanagement_storage_service | StringToUint32 经有符号 int 解析并在 INT32_MAX 处截断 | 整数溢出/下溢 | `services/storage_daemon/utils/file_utils.cpp` | 已确认并修复 |  | DTS2026082537775 |
