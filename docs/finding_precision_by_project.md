...
| [`arkui_napi`](#arkui-napi) | 3 | 0 | 0 | 3 | 100% |
...
| `DTS2026081133240` | `multimedia_media_foundation` | ShareMemory Write/Read pass raw size to ashmem | Different APIs, different jobs |
...
- `DTS2026090922585` — [OH-2026-ARKUI-011](../content/issues/OH-2026-ARKUI-011.md): BubbleLayoutAlgorithm::GetP2 asin domain break → NaN arrow clip path
- `DTS2609150107715` — [OH-2026-ARKUI-019](../content/issues/OH-2026-ARKUI-019.md): LazyGridLayoutInfo::SetSpace places a scrolled window one line too high when lanes > 1
- `DTS2609150123188` — [OH-2026-ARKUI-020](../content/issues/OH-2026-ARKUI-020.md): LazyGridLayoutInfo::UpdatePosMapEnd leaves totalMainSize_ at the previous line end when the last line is partial
...
- `DTS2609150153174` — [OH-2026-ARKUI-012](../content/issues/OH-2026-ARKUI-012.md): Backward GetTargetIndexInfoWithBenchMark starts a new line after a partial last matrix line
- `DTS2026090919800` — [OH-2026-ARKUI-013](../content/issues/OH-2026-ARKUI-013.md): MediaQueryer::MatchCondition drops AND-group when it is not the last OR-clause
- `DTS2026090920220` — [OH-2026-ARKUI-014](../content/issues/OH-2026-ARKUI-014.md): CheckColorAlpha casts unit alpha to uint8_t before scaling to 255
...
- `DTS2026072716582` — [OH-2026-CAM-014](../content/issues/OH-2026-CAM-014.md): UpdateDeviceDeferredability photo pair walk OOB on odd item.count
...
- `DTS2026072832082` — [OH-2026-CAM-015](../content/issues/OH-2026-CAM-015.md): OHOS_ABILITY_EQUIVALENT_FOCUS pair walk OOB on odd item.count
...
High-confidence project: **15** accepted fixes and **no** rejected DTS.
...
- `DTS2026081716365` — [ARK-2026-ENC-001](../content/issues/ARK-2026-ENC-001.md): Utf16ToUTF8Bytes low-surrogate mask 0xDC00 instead of 0x3FF (fixed in internal system)
...
Mixed outcomes: maintainers accepted **11** and rejected **1**. Net precision **92%**.
...
- `DTS2026072515209` — [OH-2026-ABILITY-007](../content/issues/OH-2026-ABILITY-007.md): ParseNormalizedOhmUrl short import path substr throws std::out_of_range on preload-SO startup
...
- `DTS2026090130983` — [OH-2026-AVCODEC-006](../content/issues/OH-2026-AVCODEC-006.md): DashStrToNonNegativeDouble accepts NaN (`result < 0` misses unordered)
...
- `DTS2026082129239` — [OH-2026-MF-002](../content/issues/OH-2026-MF-002.md): Format move ctor/assign shares meta_ instead of transferring ownership
...
- `DTS2026081133240` — ShareMemory Write/Read pass raw size to ashmem. *Different job — HDI frames all-or-nothing; sibling AVMemory/Memory partial I/O.*

Mixed outcomes: maintainers accepted **2** and rejected **5**. Net precision **29%**.
...
- `DTS2026082738345` — DeviceMatrix::ConvertIndex trailing index-- uint16 wrap. *Version-layout adapter — old dynamicApps_ has one fewer slot; wrap not on live ConvertDynamic path.*
...
- `DTS2026082568985` — ConvertStrToInt returns positive wrap of overflowing decimals. *Dead code / no shipped callers.*
...
- `DTS2026081715017` — MediaFileUtils::IsValidInteger accepts partial parses. *By design — incomplete consume (compat 1.000); ConvertToInt is the full-consume sibling.*
...
- `DTS2026081440197` — [OH-2026-NAPI-003](../content/issues/OH-2026-NAPI-003.md): NativeCallbackScopeManager::Close decrements depth on nullptr → size_t underflow
...
- `DTS2026082239182` — [OH-2026-NAPI-002](../content/issues/OH-2026-NAPI-002.md): napi_check_object_type_tag false-mismatches tags with upper == 0
...
This repo’s [`content/issues/`](../content/issues/) currently carries **127** DTS-linked reports (**119** `CONFIRMED_FIXED` + **8** `CONFIRMED_REAL`).
...
|------------|------:|------|
| Decided DTS (FIXED + CONFIRMED + NON-ISSUE) | 149 | Ground truth for precision |
| FIXED | 119 | Maintainer-accepted and fixed |
| CONFIRMED | 8 | Maintainer-accepted, not fixed yet |
| NON-ISSUE | 22 | Maintainer-rejected (cloned + testing inventory) |
| Write-ups in `content/issues` with DTS | 127 | Published confirmed bugs (fixed or awaiting fix) |
...
| `DTS2026081716365` | [ARK-2026-ENC-001](../content/issues/ARK-2026-ENC-001.md) | Input Validation — Encoding / Unicode | MEDIUM | `arkcompiler_runtime_core` |
...
| `DTS2026080754676` | [ARK-2026-BUF-002](../content/issues/ARK-2026-BUF-002.md) | MEDIUM | CWE-125 (Out-of-bounds Read) | `static_core/libarkfile/helpers.h` · `arkcompiler_runtime_core` | Static helpers::Read<WIDTH> short span → OOB read + size_t underflow |
| `DTS2026080810178` | [ARK-2026-BUF-003](../content/issues/ARK-2026-BUF-003.md) | MEDIUM | CWE-125 (Out-of-bounds Read) | `static_core/libarkfile/helpers.h` · `arkcompiler_runtime_core` | Static EnumerateTaggedValues empty span sp[0] OOB |
| `DTS2026080810367` | [ARK-2026-BUF-004](../content/issues/ARK-2026-BUF-004.md) | MEDIUM | CWE-125 (Out-of-bounds Read) | `static_core/libarkfile/helpers.h` · `arkcompiler_runtime_core` | Static GetOptionalTaggedValue empty span sp[0] OOB |
...
| `DTS2026081716365` | [ARK-2026-ENC-001](../content/issues/ARK-2026-ENC-001.md) | MEDIUM | CWE-176 (Improper Handling of Unicode Encoding) | `static_core/plugins/ets/runtime/intrinsics/helpers/array_buffer_helper.cpp` · `arkcompiler_runtime_core` | Utf16ToUTF8Bytes ANDs with LOW_AGENT_MASK 0xDC00 instead of 0x3FF; low surrogate always 0xDC00 |
