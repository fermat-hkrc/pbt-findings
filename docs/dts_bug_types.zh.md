...
`REAL` = 已修复 + 已确认（本目录）。`NI` = [非问题](#非问题)。**精确率** = `(FIXED + CONFIRMED) / (FIXED + CONFIRMED + NI)`。
...
| `DTS2026063023525` | [OH-2026-BT-001](../content/issues/OH-2026-BT-001.md) | 代数 — 往返 | HIGH | `communication_bluetooth_service` |
| `DTS2026063027223` | [OH-2026-BT-002](../content/issues/OH-2026-BT-002.md) | 否定 / 错误契约 | HIGH | `communication_bluetooth_service` |
...
| `DTS2026073028465` | [OH-2026-WIFI-002](../content/issues/OH-2026-WIFI-002.md) | 仅崩溃 | HIGH | `communication_wifi` |
...
| `DTS2026080300753` | [OH-2026-AVSESSION-002](../content/issues/OH-2026-AVSESSION-002.md) | 代数 — 往返 | MEDIUM | `multimedia_av_session` |
...
| `DTS2026080812034` | [ARK-2026-INT-004](../content/issues/ARK-2026-INT-004.md) | 代数 — 不变量 | MEDIUM | `arkcompiler_runtime_core` |
...
| `DTS2026081440197` | [OH-2026-NAPI-003](../content/issues/OH-2026-NAPI-003.md) | 代数 — 不变量 | MEDIUM | `arkui_napi` |
...
| `DTS2026082249247` | [OH-2026-IMG-011](../content/issues/OH-2026-IMG-011.md) | 代数 — 不变量 | MEDIUM | `multimedia_image_framework` |
...
| `DTS2026082537775` | [OH-2026-STORAGE-002](../content/issues/OH-2026-STORAGE-002.md) | 差分 | MEDIUM | `filemanagement_storage_service` |
| `DTS2026082563048` | [ARK-2026-INT-003](../content/issues/ARK-2026-INT-003.md) | 差分 | HIGH | `arkcompiler_runtime_core` |
| `DTS2026082564627` | [OH-2026-TEL-001](../content/issues/OH-2026-TEL-001.md) | 仅崩溃 | HIGH | `telephony_core_service` |
| `DTS2026082567022` | [OH-2026-CAM-013](../content/issues/OH-2026-CAM-013.md) | 否定 / 错误契约 | MEDIUM | `multimedia_camera_framework` |
...
| `DTS2026082537775` | [OH-2026-STORAGE-002](../content/issues/OH-2026-STORAGE-002.md) | MEDIUM | StringToUint32 ≡ std::from_chars（每个完整消费的 uint32 十进制） |
| `DTS2026082563048` | [ARK-2026-INT-003](../content/issues/ARK-2026-INT-003.md) | HIGH | ParseInt 完整消费的 long long 十进制 ≡ 独立 strtoll（errno==ERANGE 拒绝） |
...
| `DTS2026080812034` | [ARK-2026-INT-004](../content/issues/ARK-2026-INT-004.md) | MEDIUM | offset >= fileSize ⇒ GetSpanFromId 拒绝（无 size_t 回绕 Last） |
...
| `DTS2026081440197` | [OH-2026-NAPI-003](../content/issues/OH-2026-NAPI-003.md) | MEDIUM | Close(nullptr) 不改 depth（无 size_t 下溢） |
...
| DTS | ID | 严重级别 | 失败的性质 |
|-----|----|----------|------------------|
| `DTS2026063027223` | [OH-2026-BT-002](../content/issues/OH-2026-BT-002.md) | HIGH | 非 hex / 奇数长度 hex 被拒绝（不抛、无前缀解析） |
| `DTS2026071428596` | [OH-2026-CAM-002](../content/issues/OH-2026-CAM-002.md) | MEDIUM | 单元素美颜范围返回 OK/INVALID_ARG，不 SIGFPE |
| `DTS2026071727054` | [OH-2026-NET-008](../content/issues/OH-2026-NET-008.md) | MEDIUM | StrToUint64("-1") 返回 defaultErr（不绕成 UINT64_MAX） |
...
| `DTS2026071806648` | [OH-2026-MEDIALIB-002](../content/issues/OH-2026-MEDIALIB-002.md) | MEDIUM | GetTimeIdFromUri 对空 / 非整数 offset 不抛 |
