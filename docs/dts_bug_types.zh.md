...
- **已判定**：**129** = 107 + 1 + 21
- **精确率**：**83.7%** = `(107 + 1) / (107 + 1 + 21)` =（已修复 + 已确认）/（已修复 + 已确认 + 非问题）
- **严重级别**（已修复 + 已确认）：HIGH=25，MEDIUM=80，LOW=3
- **生成时间**：2026-09-22
...
| `arkui_ace_engine` | 11 | 4 | 5 | 6 | 0 | 73% |
...
**精确率** =（已修复 + 已确认）/（已修复 + 已确认 + 非问题）= **(107 + 1) / (107 + 1 + 21) = 83.7%**。
