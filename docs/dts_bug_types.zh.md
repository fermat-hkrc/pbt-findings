...
- **已确认（FIXED）**：**104** — 下列目录（`CONFIRMED_FIXED` 报告）
- **非问题（NON-ISSUE）**：**21** — [目录](#非问题)
- **已判定**：**125** = 104 + 21
- **精确率**：**83.2%** = `104 / (104 + 21)` = 已确认 /（已确认 + 非问题）
- **严重级别**（仅已确认）：HIGH=24，MEDIUM=77，LOW=3
- **生成时间**：2026-09-22
...
**精确率** = 已确认 /（已确认 + 非问题）= **104 / (104 + 21) = 83.2%**。
