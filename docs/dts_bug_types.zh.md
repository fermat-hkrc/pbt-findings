...
- **已确认（FIXED）**：**100** — 下列目录（`CONFIRMED_FIXED` 报告）
- **非问题（NON-ISSUE）**：**16** — [目录](#非问题)
- **已判定**：**116** = 100 + 16
- **精确率**：**86.2%** = `100 / (100 + 16)` = 已确认 /（已确认 + 非问题）
- **严重级别**（仅已确认）：HIGH=22，MEDIUM=75，LOW=3
- **生成时间**：2026-09-17
...
**精确率** = 已确认 /（已确认 + 非问题）= **100 / (100 + 16) = 86.2%**。
