...
- **Confirmed (FIXED)**: **114** — `CONFIRMED_FIXED` write-ups below
- **Confirmed (awaiting fix)**: **8** — `CONFIRMED_REAL` (OH-2026-ARKUI-010, 012–018)
- **Non-issue**: **22** — [catalog](#non-issues)
- **Decided**: **144** = 114 + 8 + 22
- **Precision**: **84.7%** = `(114 + 8) / (114 + 8 + 22)` = (fixed + confirmed) / (fixed + confirmed + non-issues)
- **Severity** (fixed + confirmed): HIGH=28, MEDIUM=91, LOW=3
...
| [Algebraic — Invariant](#algebraic--invariant) | 41 | 10 | 30 | 1 |
...
`REAL` = fixed + confirmed (this catalog). `NI` = [non-issues](#non-issues). **Precision** = `(FIXED + CONFIRMED) / (FIXED + CONFIRMED + NI)`.
...
| `DTS2026081440197` | [OH-2026-NAPI-003](../content/issues/OH-2026-NAPI-003.md) | Algebraic — Invariant | MEDIUM | `arkui_napi` |
| `DTS2026081506434` | [OH-2026-NAPI-001](../content/issues/OH-2026-NAPI-001.md) | Differential | MEDIUM | `arkui_napi` |
...
| `DTS2026082563048` | [ARK-2026-INT-003](../content/issues/ARK-2026-INT-003.md) | Differential | HIGH | `arkcompiler_runtime_core` |
...
| `DTS2026090922585` | [OH-2026-ARKUI-011](../content/issues/OH-2026-ARKUI-011.md) | Algebraic — Invariant | MEDIUM | `arkui_ace_engine` |
...
| `DTS2609150153371` | [OH-2026-ARKUI-010](../content/issues/OH-2026-ARKUI-010.md) | Algebraic — Invariant | MEDIUM | `arkui_ace_engine` |
...
| `DTS2026082537775` | [OH-2026-STORAGE-002](../content/issues/OH-2026-STORAGE-002.md) | MEDIUM | StringToUint32 ≡ std::from_chars on every full-consume uint32 decimal |
| `DTS2026082563048` | [ARK-2026-INT-003](../content/issues/ARK-2026-INT-003.md) | HIGH | ParseInt(full-consume long long decimal) ≡ independent strtoll (reject on errno==ERANGE) |
...
| `DTS2026090920220` | [OH-2026-ARKUI-014](../content/issues/OH-2026-ARKUI-014.md) | HIGH | CheckColorAlpha(rgba unit α) ≡ FromRGBO |
...
| `DTS2026082239182` | [OH-2026-NAPI-002](../content/issues/OH-2026-NAPI-002.md) | MEDIUM | check(tag_object(obj, T), T) == true for every T (incl. upper == 0) |
...
| `DTS2026091029544` | [OH-2026-ARKUI-015](../content/issues/OH-2026-ARKUI-015.md) | MEDIUM | Slerp(from, to, 0) == from (even when from·to < 0) |
| `DTS2609150123188` | [OH-2026-ARKUI-020](../content/issues/OH-2026-ARKUI-020.md) | MEDIUM | covering totalMainSize_ ≡ last.endPos (≡ UpdateTotalMainSize) |
| `DTS2609150153174` | [OH-2026-ARKUI-012](../content/issues/OH-2026-ARKUI-012.md) | MEDIUM | backward seed ≡ pack-from-0 (partial last matrix line) |
...
| `DTS2026081440197` | [OH-2026-NAPI-003](../content/issues/OH-2026-NAPI-003.md) | MEDIUM | Close(nullptr) leaves depth unchanged (no size_t underflow) |
...
**Precision** = (fixed + confirmed) / (fixed + confirmed + non-issues) = **(114 + 8) / (114 + 8 + 22) = 84.7%**.
